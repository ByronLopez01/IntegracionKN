...
builder.Services.AddControllers(); // Aseg�rate de que los servicios para los controladores est�n registrados
...
app.MapControllers(); // Aseg�rate de que las rutas para los controladores est�n configuradas
